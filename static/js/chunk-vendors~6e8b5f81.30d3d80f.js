...
var DayGridDateProfileGenerator = /** @class */ (function (_super) {
    ...
    DayGridDateProfileGenerator.prototype.buildRenderRange = function (currentRange, currentRangeUnit, isRangeAllDay) {
        ...
        if (this.options.monthMode &&
            ...
            Object(_fullcalendar_core__WEBPACK_IMPORTED_MODULE_0__[/* diffWeeks */ "B"])(start, end));
...
var Popover = /** @class */ (function () {
    ...
    Popover.prototype.render = function () {
        ...
        var el = this.el = Object(_fullcalendar_core__WEBPACK_IMPORTED_MODULE_0__[/* createElement */ "x"])('div', {
        ...
        Object(_fullcalendar_core__WEBPACK_IMPORTED_MODULE_0__[/* listenBySelector */ "K"])(el, 'click', '.fc-close', function (ev) {
            _this.hide();
        });
        if (options.autoHide) {
    ...
    Popover.prototype.destroy = function () {
        this.hide();
        if (this.el) {
            Object(_fullcalendar_core__WEBPACK_IMPORTED_MODULE_0__[/* removeElement */ "Q"])(this.el);
            this.el = null;
        }
    ...
    Popover.prototype.position = function () {
        ...
        var origin = Object(_fullcalendar_core__WEBPACK_IMPORTED_MODULE_0__[/* computeRect */ "w"])(el.offsetParent);
...
var SimpleDayGridEventRenderer = /** @class */ (function (_super) {
    ...
    SimpleDayGridEventRenderer.prototype.renderSegHtml = function (seg, mirrorInfo) {
        ...
        var isDraggable = Object(_fullcalendar_core__WEBPACK_IMPORTED_MODULE_0__[/* computeEventDraggable */ "t"])(context, eventDef, eventUi);
        var isResizableFromStart = allDay && seg.isStart && Object(_fullcalendar_core__WEBPACK_IMPORTED_MODULE_0__[/* computeEventStartResizable */ "v"])(context, eventDef, eventUi);
        var isResizableFromEnd = allDay && seg.isEnd && Object(_fullcalendar_core__WEBPACK_IMPORTED_MODULE_0__[/* computeEventEndResizable */ "u"])(context, eventDef, eventUi);
        var classes = this.getSegClasses(seg, isDraggable, isResizableFromStart || isResizableFromEnd, mirrorInfo);
        var skinCss = Object(_fullcalendar_core__WEBPACK_IMPORTED_MODULE_0__[/* cssToStr */ "A"])(this.getSkinCss(eventUi));
        var timeHtml = '';
        var timeText;
        var titleHtml;
        ...
        if (seg.isStart) {
            ...
            if (timeText) {
                timeHtml = '<span class="fc-time">' + Object(_fullcalendar_core__WEBPACK_IMPORTED_MODULE_0__[/* htmlEscape */ "G"])(timeText) + '</span>';
            }
        }
        titleHtml =
            '<span class="fc-title">' +
                (Object(_fullcalendar_core__WEBPACK_IMPORTED_MODULE_0__[/* htmlEscape */ "G"])(eventDef.title || '') || '&nbsp;') + // we always want one line of height
                '</span>';
        return '<a class="' + classes.join(' ') + '"' +
            (eventDef.url ?
                ' href="' + Object(_fullcalendar_core__WEBPACK_IMPORTED_MODULE_0__[/* htmlEscape */ "G"])(eventDef.url) + '"' :
                '') +
            (skinCss ?
                ' style="' + skinCss + '"' :
                '') +
...
var DayGridEventRenderer = /** @class */ (function (_super) {
    ...
    DayGridEventRenderer.prototype.detachSegs = function () {
        ...
        while ((rowStruct = rowStructs.pop())) {
            Object(_fullcalendar_core__WEBPACK_IMPORTED_MODULE_0__[/* removeElement */ "Q"])(rowStruct.tbodyEl);
        }
        ...
        for (i = 0; i < levelCnt; i++) { // iterate through all levels
            ...
            if (levelSegs) {
                for (j = 0; j < levelSegs.length; j++) { // iterate through segments in level
                    ...
                    td = Object(_fullcalendar_core__WEBPACK_IMPORTED_MODULE_0__[/* createElement */ "x"])('td', { className: 'fc-event-container' }, seg.el);
                    if (leftCol !== rightCol) {
            ...
            if (introHtml) {
                if (isRtl) {
                    ...
                    Object(_fullcalendar_core__WEBPACK_IMPORTED_MODULE_0__[/* prependToElement */ "O"])(tr, introHtml);
                }
            }
...
var DayGridMirrorRenderer = /** @class */ (function (_super) {
    ...
    DayGridMirrorRenderer.prototype.attachSegs = function (segs, mirrorInfo) {
        ...
        this.dayGrid.rowEls.forEach(function (rowNode, row) {
            var skeletonEl = Object(_fullcalendar_core__WEBPACK_IMPORTED_MODULE_0__[/* htmlToElement */ "H"])('<div class="fc-mirror-skeleton"><table></table></div>'); // will be absolutely positioned
            var skeletonTopEl;
            var skeletonTop;
...
var DayGridFillRenderer = /** @class */ (function (_super) {
    ...
    DayGridFillRenderer.prototype.renderFillRow = function (type, seg) {
        ...
        skeletonEl = Object(_fullcalendar_core__WEBPACK_IMPORTED_MODULE_0__[/* htmlToElement */ "H"])('<div class="fc-' + className + '-skeleton">' +
            '<table><tr></tr></table>' +
            '</div>');
        ...
        if (introHtml) {
            if (isRtl) {
                ...
                Object(_fullcalendar_core__WEBPACK_IMPORTED_MODULE_0__[/* prependToElement */ "O"])(trEl, introHtml);
            }
        }
        return skeletonEl;
    };
...
var DayTile = /** @class */ (function (_super) {
    ...
    function DayTile(el) {
        ...
        var renderFrame = _this.renderFrame = Object(_fullcalendar_core__WEBPACK_IMPORTED_MODULE_0__[/* memoizeRendering */ "N"])(_this._renderFrame);
        _this.renderFgEvents = Object(_fullcalendar_core__WEBPACK_IMPORTED_MODULE_0__[/* memoizeRendering */ "N"])(eventRenderer.renderSegs.bind(eventRenderer), eventRenderer.unrender.bind(eventRenderer), [renderFrame]);
        _this.renderEventSelection = Object(_fullcalendar_core__WEBPACK_IMPORTED_MODULE_0__[/* memoizeRendering */ "N"])(eventRenderer.selectByInstanceId.bind(eventRenderer), eventRenderer.unselectByInstanceId.bind(eventRenderer), [_this.renderFgEvents]);
        _this.renderEventDrag = Object(_fullcalendar_core__WEBPACK_IMPORTED_MODULE_0__[/* memoizeRendering */ "N"])(eventRenderer.hideByHash.bind(eventRenderer), eventRenderer.showByHash.bind(eventRenderer), [renderFrame]);
        _this.renderEventResize = Object(_fullcalendar_core__WEBPACK_IMPORTED_MODULE_0__[/* memoizeRendering */ "N"])(eventRenderer.hideByHash.bind(eventRenderer), eventRenderer.showByHash.bind(eventRenderer), [renderFrame]);
        return _this;
    }
    ...
    DayTile.prototype._renderFrame = function (date) {
        ...
        var title = dateEnv.format(date, Object(_fullcalendar_core__WEBPACK_IMPORTED_MODULE_0__[/* createFormatter */ "y"])(options.dayPopoverFormat) // TODO: cache
        );
        this.el.innerHTML =
            '<div class="fc-header ' + theme.getClass('popoverHeader') + '">' +
                '<span class="fc-title">' +
                Object(_fullcalendar_core__WEBPACK_IMPORTED_MODULE_0__[/* htmlEscape */ "G"])(title) +
                '</span>' +
...
var DayTileEventRenderer = /** @class */ (function (_super) {
    ...
    DayTileEventRenderer.prototype.detachSegs = function (segs) {
        for (var _i = 0, segs_2 = segs; _i < segs_2.length; _i++) {
            var seg = segs_2[_i];
            Object(_fullcalendar_core__WEBPACK_IMPORTED_MODULE_0__[/* removeElement */ "Q"])(seg.el);
        }
    };
...
function renderCellHtml(date, dateProfile, context, otherAttrs) {
    ...
    var isDateValid = Object(_fullcalendar_core__WEBPACK_IMPORTED_MODULE_0__[/* rangeContainsMarker */ "P"])(dateProfile.activeRange, date); // TODO: called too frequently. cache somehow.
    var classes = Object(_fullcalendar_core__WEBPACK_IMPORTED_MODULE_0__[/* getDayClasses */ "F"])(date, dateProfile, context);
...
var DAY_NUM_FORMAT = Object(_fullcalendar_core__WEBPACK_IMPORTED_MODULE_0__[/* createFormatter */ "y"])({ day: 'numeric' });
var WEEK_NUM_FORMAT = Object(_fullcalendar_core__WEBPACK_IMPORTED_MODULE_0__[/* createFormatter */ "y"])({ week: 'numeric' });
var DayGrid = /** @class */ (function (_super) {
    ...
    function DayGrid(el, renderProps) {
        ...
        var renderCells = _this.renderCells = Object(_fullcalendar_core__WEBPACK_IMPORTED_MODULE_0__[/* memoizeRendering */ "N"])(_this._renderCells, _this._unrenderCells);
        _this.renderBusinessHours = Object(_fullcalendar_core__WEBPACK_IMPORTED_MODULE_0__[/* memoizeRendering */ "N"])(fillRenderer.renderSegs.bind(fillRenderer, 'businessHours'), fillRenderer.unrender.bind(fillRenderer, 'businessHours'), [renderCells]);
        _this.renderDateSelection = Object(_fullcalendar_core__WEBPACK_IMPORTED_MODULE_0__[/* memoizeRendering */ "N"])(fillRenderer.renderSegs.bind(fillRenderer, 'highlight'), fillRenderer.unrender.bind(fillRenderer, 'highlight'), [renderCells]);
        _this.renderBgEvents = Object(_fullcalendar_core__WEBPACK_IMPORTED_MODULE_0__[/* memoizeRendering */ "N"])(fillRenderer.renderSegs.bind(fillRenderer, 'bgEvent'), fillRenderer.unrender.bind(fillRenderer, 'bgEvent'), [renderCells]);
        _this.renderFgEvents = Object(_fullcalendar_core__WEBPACK_IMPORTED_MODULE_0__[/* memoizeRendering */ "N"])(eventRenderer.renderSegs.bind(eventRenderer), eventRenderer.unrender.bind(eventRenderer), [renderCells]);
        _this.renderEventSelection = Object(_fullcalendar_core__WEBPACK_IMPORTED_MODULE_0__[/* memoizeRendering */ "N"])(eventRenderer.selectByInstanceId.bind(eventRenderer), eventRenderer.unselectByInstanceId.bind(eventRenderer), [_this.renderFgEvents]);
        _this.renderEventDrag = Object(_fullcalendar_core__WEBPACK_IMPORTED_MODULE_0__[/* memoizeRendering */ "N"])(_this._renderEventDrag, _this._unrenderEventDrag, [renderCells]);
        _this.renderEventResize = Object(_fullcalendar_core__WEBPACK_IMPORTED_MODULE_0__[/* memoizeRendering */ "N"])(_this._renderEventResize, _this._unrenderEventResize, [renderCells]);
        return _this;
    }
    ...
    DayGrid.prototype._renderCells = function (cells, isRigid) {
        ...
        this.rowEls = Object(_fullcalendar_core__WEBPACK_IMPORTED_MODULE_0__[/* findElements */ "E"])(this.el, '.fc-row');
        this.cellEls = Object(_fullcalendar_core__WEBPACK_IMPORTED_MODULE_0__[/* findElements */ "E"])(this.el, '.fc-day, .fc-disabled-day');
        if (isRtl) {
    ...
    DayGrid.prototype.renderNumberCellHtml = function (date) {
        ...
        var html = '';
        var isDateValid = Object(_fullcalendar_core__WEBPACK_IMPORTED_MODULE_0__[/* rangeContainsMarker */ "P"])(this.props.dateProfile.activeRange, date); // TODO: called too frequently. cache somehow.
        ...
        classes = Object(_fullcalendar_core__WEBPACK_IMPORTED_MODULE_0__[/* getDayClasses */ "F"])(date, this.props.dateProfile, this.context);
        ...
        if (this.renderProps.cellWeekNumbersVisible && (date.getUTCDay() === weekCalcFirstDow)) {
            html += Object(_fullcalendar_core__WEBPACK_IMPORTED_MODULE_0__[/* buildGotoAnchorHtml */ "q"])(options, dateEnv, { date: date, type: 'week' }, { 'class': 'fc-week-number' }, dateEnv.format(date, WEEK_NUM_FORMAT) // inner HTML
            );
        }
        if (isDayNumberVisible) {
            html += Object(_fullcalendar_core__WEBPACK_IMPORTED_MODULE_0__[/* buildGotoAnchorHtml */ "q"])(options, dateEnv, date, { 'class': 'fc-day-number' }, dateEnv.format(date, DAY_NUM_FORMAT) // inner HTML
            );
        }
        html += '</td>';
        return html;
    ...
    DayGrid.prototype.computeRowLevelLimit = function (row) {
        ...
        var trEls = Object(_fullcalendar_core__WEBPACK_IMPORTED_MODULE_0__[/* findChildren */ "D"])(this.eventRenderer.rowStructs[row].tbodyEl);
        var i;
        var trEl;
    ...
    DayGrid.prototype.limitRow = function (row, levelLimit) {
        ...
        var emptyCellsUntil = function (endCol) {
            while (col < endCol) {
                ...
                if (segsBelow.length) {
                    ...
                    moreWrap = Object(_fullcalendar_core__WEBPACK_IMPORTED_MODULE_0__[/* createElement */ "x"])('div', null, moreLink);
        ...
        if (levelLimit && levelLimit < rowStruct.segLevels.length) { // is it actually over the limit?
            ...
            limitedNodes = Object(_fullcalendar_core__WEBPACK_IMPORTED_MODULE_0__[/* findChildren */ "D"])(rowStruct.tbodyEl).slice(levelLimit); // get level <tr> elements past the limit
            ...
            for (i = 0; i < levelSegs.length; i++) {
                ...
                if (totalSegsBelow) { // do we need to replace this segment with one or many "more" links?
                    ...
                    for (j = 0; j < colSegsBelow.length; j++) {
                        moreTd = Object(_fullcalendar_core__WEBPACK_IMPORTED_MODULE_0__[/* createElement */ "x"])('td', { className: 'fc-more-cell', rowSpan: rowSpan });
                    ...
                    Object(_fullcalendar_core__WEBPACK_IMPORTED_MODULE_0__[/* insertAfterElement */ "I"])(td, segMoreNodes);
    ...
    DayGrid.prototype.unlimitRow = function (row) {
        ...
        if (rowStruct.moreEls) {
            rowStruct.moreEls.forEach(_fullcalendar_core__WEBPACK_IMPORTED_MODULE_0__[/* removeElement */ "Q"]);
    ...
    DayGrid.prototype.renderMoreLink = function (row, col, hiddenSegs) {
        ...
        var a = Object(_fullcalendar_core__WEBPACK_IMPORTED_MODULE_0__[/* createElement */ "x"])('a', { className: 'fc-more' });
    ...
    DayGrid.prototype.showSegPopover = function (row, col, moreLink, segs) {
        ...
        options = {
            ...
            parentEl: view.el,
            top: Object(_fullcalendar_core__WEBPACK_IMPORTED_MODULE_0__[/* computeRect */ "w"])(topEl).top,
            autoHide: true,
            content: function (el) {
        ...
        if (isRtl) {
            options.right = Object(_fullcalendar_core__WEBPACK_IMPORTED_MODULE_0__[/* computeRect */ "w"])(moreWrap).right + 1; // +1 to be over cell border
        }
        else {
            options.left = Object(_fullcalendar_core__WEBPACK_IMPORTED_MODULE_0__[/* computeRect */ "w"])(moreWrap).left - 1; // -1 to be over cell border
        }
    ...
    DayGrid.prototype.resliceDaySegs = function (segs, dayDate) {
        ...
        for (var _i = 0, segs_1 = segs; _i < segs_1.length; _i++) {
            ...
            var slicedRange = Object(_fullcalendar_core__WEBPACK_IMPORTED_MODULE_0__[/* intersectRanges */ "J"])(origRange, dayRange);
            if (slicedRange) {
...
var WEEK_NUM_FORMAT$1 = Object(_fullcalendar_core__WEBPACK_IMPORTED_MODULE_0__[/* createFormatter */ "y"])({ week: 'numeric' });
...
var AbstractDayGridView = /** @class */ (function (_super) {
    ...
    function AbstractDayGridView() {
        ...
        _this.processOptions = Object(_fullcalendar_core__WEBPACK_IMPORTED_MODULE_0__[/* memoize */ "M"])(_this._processOptions);
        _this.renderSkeleton = Object(_fullcalendar_core__WEBPACK_IMPORTED_MODULE_0__[/* memoizeRendering */ "N"])(_this._renderSkeleton, _this._unrenderSkeleton);
        /* Header Rendering
        ------------------------------------------------------------------------------------------------------------------*/
        ...
        _this.renderHeadIntroHtml = function () {
            ...
            if (_this.colWeekNumbersVisible) {
                return '' +
                    ...
                    Object(_fullcalendar_core__WEBPACK_IMPORTED_MODULE_0__[/* htmlEscape */ "G"])(options.weekLabel) +
                    '</span>' +
                    '</th>';
            }
            return '';
    ...
    AbstractDayGridView.prototype._renderSkeleton = function (context) {
        ...
        this.scroller = new _fullcalendar_core__WEBPACK_IMPORTED_MODULE_0__[/* ScrollComponent */ "j"]('hidden', // overflow x
        'auto' // overflow y
        );
        var dayGridContainerEl = this.scroller.el;
        this.el.querySelector('.fc-body > tr > td').appendChild(dayGridContainerEl);
        dayGridContainerEl.classList.add('fc-day-grid-container');
        var dayGridEl = Object(_fullcalendar_core__WEBPACK_IMPORTED_MODULE_0__[/* createElement */ "x"])('div', { className: 'fc-day-grid' });
    ...
    AbstractDayGridView.prototype.updateBaseSize = function (isResize, viewHeight, isAuto) {
        ...
        if (this.colWeekNumbersVisible) {
            ...
            this.weekNumberWidth = Object(_fullcalendar_core__WEBPACK_IMPORTED_MODULE_0__[/* matchCellWidths */ "L"])(Object(_fullcalendar_core__WEBPACK_IMPORTED_MODULE_0__[/* findElements */ "E"])(this.el, '.fc-week-number'));
        }
        // reset all heights to be natural
        this.scroller.clear();
        if (headRowEl) {
            Object(_fullcalendar_core__WEBPACK_IMPORTED_MODULE_0__[/* uncompensateScroll */ "S"])(headRowEl);
        }
    ...
    AbstractDayGridView.prototype.computeScrollerHeight = function (viewHeight) {
        return viewHeight -
            Object(_fullcalendar_core__WEBPACK_IMPORTED_MODULE_0__[/* subtractInnerElHeight */ "R"])(this.el, this.scroller.el); // everything that's NOT the scroller
    };
    ...
    AbstractDayGridView.prototype.setGridHeight = function (height, isAuto) {
        if (this.context.options.monthMode) {
            ...
            Object(_fullcalendar_core__WEBPACK_IMPORTED_MODULE_0__[/* distributeHeight */ "C"])(this.dayGrid.rowEls, height, !isAuto); // if auto, don't compensate for height-hogging rows
        }
        else {
            if (isAuto) {
                Object(_fullcalendar_core__WEBPACK_IMPORTED_MODULE_0__[/* undistributeHeight */ "T"])(this.dayGrid.rowEls); // let the rows be their natural height with no expanding
            }
            else {
                Object(_fullcalendar_core__WEBPACK_IMPORTED_MODULE_0__[/* distributeHeight */ "C"])(this.dayGrid.rowEls, height, true); // true = compensate for height-hogging rows
            }
        }
    };
    /* Scroll
...
var DayGridView = /** @class */ (function (_super) {
    ...
    function DayGridView() {
        var _this = _super !== null && _super.apply(this, arguments) || this;
        _this.buildDayTable = Object(_fullcalendar_core__WEBPACK_IMPORTED_MODULE_0__[/* memoize */ "M"])(buildDayTable);
        return _this;
    }
    ...
    DayGridView.prototype._renderSkeleton = function (context) {
        ...
        if (context.options.columnHeader) {
            this.header = new _fullcalendar_core__WEBPACK_IMPORTED_MODULE_0__[/* DayHeader */ "d"](this.el.querySelector('.fc-head-container'));
        }
...
var main = Object(_fullcalendar_core__WEBPACK_IMPORTED_MODULE_0__[/* createPlugin */ "z"])({
