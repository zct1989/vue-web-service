          ...
          <template v-slot:content>
            ...
            >
              ...
              <div class="flex-auto text-right">
                <a-icon v-if="model.status === item.key" type="check" />
              </div>
            </div>
          </template>
          <div class="status-container flex-row">
            <a-icon :type="status.icon" :style="{ color: status.color }" />
        ...
        <a-row class="padding">
          ...
          <a-col span="24" class="margin-y">
            ...
            <div class="flex-row align-items-center">
              <a-avatar :size="30" style="margin-right:10px;">张三</a-avatar>
              <a-popover
                :arrowPointAtCenter="false"
                placement="right"
                trigger="click"
              ...
              >
                ...
                <div class="members-container flex-row margin-y">
                  <a-avatar :size="30" icon="plus" style="cursor:pointer" />
                </div>
              </a-popover>
            </div>
          </a-col>
          <a-col span="24" class="margin-y">
            ...
            <div class="description-container flex-row margin-y">
              ...
              <div v-if="edit.description === true" class="margin-y">
                <a-button
                  shape="round"
                  type="primary"
                  class="margin-right"
                  ...
                  >保存</a-button
                >
                <a-button shape="round" @click="edit.description = false"
                  >取消</a-button
                >
              </div>
            </div>
        ...
        >
          ...
          <div>
            <a-button
              ...
              >发送</a-button
            >
            <a-button size="small" shape="round" @click="edit.comment = false"
              >取消</a-button
            >
          </div>
        </div>
